...
/**
 * Change l'état sans animation : le paquet se retrouve directement dans sa nouvelle position.
 ...
 */
function setEtatDirect(next: Etat): void {
...
// Un paquet neuf est l'état de départ : rien à reprendre, mais l'écrire tout de suite évite qu'un
// rechargement juste après l'ouverture reparte d'une session vide.
